...
class Patient(models.Model):
    ...
    # الحقول الجديدة
    medical_history = models.TextField(null=True, blank=True, verbose_name="Previous Medical Conditions")  # الأمراض السابقة
    allergies = models.TextField(null=True, blank=True, verbose_name="Allergies")  # الحساسية
    past_surgeries = models.TextField(null=True, blank=True, verbose_name="Past Surgeries")  # العمليات الجراحية السابقة
