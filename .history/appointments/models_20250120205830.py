...
class Appointment(models.Model):
    ...
    payment = models.ForeignKey('billing.Payment', on_delete=models.CASCADE, null=True, blank=True)  # إذا كنت ما تزال تستخدم هذا الحقل للربط بـ Payment
    payment_transaction_id = models.CharField(max_length=255, null=True, blank=True)  # حقل جديد للاحتفاظ بمعرف Stripe
